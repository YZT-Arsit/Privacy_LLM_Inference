...
|---|---|---|---|---|---|---|---|---|
| 1-4 | ours_current_greedy | sshleifer/tiny-gpt2 | gpt2_model_level_greedy | measured_wall_time_ms | 6.813033198704943 | see token_match in generation_correctness | outputs/workload_profile.json | GPT-2 model-level greedy measured wall-time. |
