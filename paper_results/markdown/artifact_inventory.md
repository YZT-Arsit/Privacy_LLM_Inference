...
|---|---|---|---|---|---|---|
| inference | workload_profile | outputs/workload_profile.json | present |  | 54856 | calibration\|config\|interaction_breakdown\|interpretation\|limitations\|methods\|module_breakdown\|paper_metrics\|wr... |
| inference | cross_architecture_summary | outputs/cross_architecture_summary.json | present |  | 57316 | architectures\|compatible_island_integration_status\|compatible_island_projection\|config\|global_summary\|stage_note... |
