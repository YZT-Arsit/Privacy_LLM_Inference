...
accuracy. Scores: `results/ours_amulet/generation_backend_eval/ifeval100/`.
...
- IFEval-20 aggregate scores + comparison + amulet evidence are saved under
  `results/ours_amulet/generation_backend_eval/ifeval20/` (full per-prompt tables live in the
