...
def main():
    ...
    binding = {
        ...
        "optimizer_profile": "o1c_hybrid_adamw_L12",
    ...
    push_a10(str(REPO / "scripts/a10_l12_runner.py"), f"{RA10}/scripts/a10_l12_runner.py")
    ...
    tdx_sess = {"session_key_hex": session_key.hex(), "run_id": run_id, "labels": labels,
                ...
                "model_cfg": {"num_attention_heads": 14, "num_key_value_heads": 2, "hidden_size": 896, "intermediate_size": 4864}}
    ...
    cmd = (f"cd {RA10} && {ENV_A10} {PY_A10} scripts/a10_l12_runner.py "
           f"--session /tmp/direct_session_a10.json --steps {args.steps} --seq-len {args.seq_len} "
           f"--lr {args.lr} --dtype {args.dtype} --input-ids {IDS} "
