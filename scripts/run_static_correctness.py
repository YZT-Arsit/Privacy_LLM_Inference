#!/usr/bin/env python
"""Run correctness checks for standard linear obfuscated execution."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--rank", type=int, default=4, help="Accepted for CLI symmetry; unused.")
    ...
    parser.add_argument("--output", type=Path, default=Path("outputs/static_correctness.json"))
    return parser.parse_args()


def main() -> None:
    """Generate random tensors, run linear paths, and write JSON metrics."""
    args = parse_args()
    set_seed(args.seed)
