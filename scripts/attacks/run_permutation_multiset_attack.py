"""Permutation/multiset/norm leakage — thin wrapper over run_all_attacks (attacks=perm).
...
Example:
    python scripts/attacks/run_permutation_multiset_attack.py
    python scripts/attacks/run_permutation_multiset_attack.py --dry-run
"""
