"""PIA prompt inversion (best_effort) — thin wrapper over run_all_attacks (attacks=pia).
...
Example:
    python scripts/attacks/run_pia_prompt_inversion.py
    python scripts/attacks/run_pia_prompt_inversion.py --dry-run
"""
