"""ArrowMatch weight alignment (worst case) — thin wrapper over run_all_attacks (attacks=arrow).
...
Example:
    python scripts/attacks/run_arrowmatch_attack.py
    python scripts/attacks/run_arrowmatch_attack.py --dry-run
"""
