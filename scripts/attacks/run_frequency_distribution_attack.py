"""Frequency/distribution analysis — thin wrapper over run_all_attacks (attacks=freq).
...
Example:
    python scripts/attacks/run_frequency_distribution_attack.py
    python scripts/attacks/run_frequency_distribution_attack.py --dry-run
"""
