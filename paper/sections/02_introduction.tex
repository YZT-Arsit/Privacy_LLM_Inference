...
% model on an untrusted accelerator exposes BOTH weights and runtime assets ->
...
% an UNTRUSTED accelerator so that the base weights AND the user's runtime assets
